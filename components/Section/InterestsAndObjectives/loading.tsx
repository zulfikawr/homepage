  ...
  return (
    <div className='animate-pulse flex flex-col px-1'>
      ...
      <div className='-mt-1 space-y-3'>
        ...
        <div className='h-[16px] w-full rounded bg-muted dark:bg-muted' />
        <div className='h-[16px] w-1/6 rounded bg-muted dark:bg-muted' />
      </div>
      ...
      {/* Objectives section */}
      <div className='h-[16px] w-48 rounded bg-muted dark:bg-muted' />
      ...
      <div className='mt-5 space-y-3'>
        <div className='h-[16px] w-full rounded bg-muted dark:bg-muted' />
        <div className='h-[16px] w-4/5 rounded bg-muted dark:bg-muted' />
      </div>
    </div>
  );
};

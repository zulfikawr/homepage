...
export const iconMap = {
  ...
  cloud: PhosphorIcons.CloudIcon,
  cloudFog: PhosphorIcons.CloudFogIcon,
  cloudLightning: PhosphorIcons.CloudLightningIcon,
  cloudMoon: PhosphorIcons.CloudMoonIcon,
  cloudRain: PhosphorIcons.CloudRainIcon,
  cloudSnow: PhosphorIcons.CloudSnowIcon,
  ...
  gitFork: PhosphorIcons.GitForkIcon,
  ...
  mdFile: PhosphorIcons.FileMdIcon,
  ...
  speaker: PhosphorIcons.SpeakerSimpleHighIcon,
  speakerSlash: PhosphorIcons.SpeakerSimpleSlashIcon,

  ...
  <BaseCardLoading>
    <>
      <div className='flex gap-6 p-6 lg:gap-8 lg:p-8'>
        ...
        <div className='h-[180px] w-[120px] flex-shrink-0 rounded-md bg-neutral-200 dark:bg-neutral-700 sm:h-[200px] sm:w-[150px]' />

        <div className='flex flex-1 flex-col space-y-4'>
          {/* Categories */}
          <div className='flex flex-wrap items-center gap-3'>
            <div className='h-6 w-16 rounded-md bg-neutral-200 dark:bg-neutral-700' />
            <div className='h-6 w-16 rounded-md bg-neutral-200 dark:bg-neutral-700' />
          </div>
      ...
      <div className='h-auto w-full border-t border-neutral-100 px-6 py-2 dark:border-neutral-700 lg:px-8 lg:py-3'>
        <div className='flex items-center justify-between whitespace-nowrap text-neutral-500 dark:text-neutral-400'>
  ...
  <BaseCardLoading>
    <>
      ...
      <div className='block md:hidden'>
        {/* Image */}
        <div className='w-full aspect-video bg-neutral-200 dark:bg-neutral-700' />

        {/* Title */}
        <div className='w-full border-b border-neutral-100 px-4 py-3 dark:border-neutral-700'>
          <div className='h-5 w-3/4 rounded bg-neutral-200 dark:bg-neutral-700' />
        </div>
      ...
      <div className='hidden md:grid md:grid-cols-4 items-center gap-4 p-4'>
        ...
        <div className='col-span-1 flex justify-center aspect-video'>
          <div className='h-20 w-full rounded-md bg-neutral-200 dark:bg-neutral-700' />
        </div>
    ...
    <div className='p-4 space-y-2'>
      ...
      <div className='flex flex-wrap gap-2 pt-2'>
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className='h-6 w-16 rounded bg-neutral-200 dark:bg-neutral-700'
          />
        ))}
      </div>
    </div>
    ...
    <>
      ...
      <div className='flex w-full items-center justify-center px-1 py-2 gap-0.5'>
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            key={i}
            className='h-4 w-4 rounded bg-neutral-200 dark:bg-neutral-700'
          />
        ))}
      </div>
    </>

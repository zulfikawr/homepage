...
const UIComponentsPage: NextPageWithLayout = () => {
  const openDrawer = () => {
    drawer.open(
      <>
        <div className='p-6'>
  ...
  return (
    <>
      <Head>
        <title>UI Components - Zulfikar</title>
      </Head>
      <div className='mt-0 pt-24 lg:mt-20 lg:pt-0 space-y-4 lg:space-y-8'>
        <div>
          <h1 className='text-3xl font-bold tracking-wide text-black dark:text-white'>
            UI Components
          </h1>
          <p className='text-gray-600 dark:text-gray-400 mt-2'>
            Explore all available UI components used in this website, in an
            interactive way.
          </p>
        </div>
...
UIComponentsPage.layout = pageLayout;
